...
# Keystone Related Documentation
...
### Deployment
`heroku login`
`heroku git:remote -a keystone-template`
`git push heroku master`

Note: Deployment can be integrated directly in Heroku's admin UI & could possibly be integrated with Github Actions CD with custom action
